...
class Script(BulletScript):
    ...
    def __init__(self, target_surface, background):
        ...
        self.emitters = [SparkEmitter(self.bullet_group, (250, 120), (200, 200, 0), 0, 2),
                         RadialEmitter(self.bullet_group, (250, 150), 'yellow', 0),

                         SparkEmitter(self.bullet_group, (300, 180), (200, 0, 200), 20, 0),
                         RadialEmitter(self.bullet_group, (300, 180), 'magenta', 20),


                         SparkEmitter(self.bullet_group, (320, 220), (0, 200, 0), 40, 0),
                         RadialEmitter(self.bullet_group, (320, 220), 'green', 40),

                         SparkEmitter(self.bullet_group, (300, 260), (0, 0, 200), 60, 0),
                         RadialEmitter(self.bullet_group, (300, 260), 'blue', 60),


                         SparkEmitter(self.bullet_group, (250, 290), (200, 0, 0), 80, -2),
                         RadialEmitter(self.bullet_group, (250, 290), 'red', 80),
